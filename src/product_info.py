...
PRODUCT_FEATURES: tuple[ProductFeature, ...] = (
    ...
    ProductFeature(
        ...
        description=(
            "Контроль остатков, приёмки, передачи в бухгалтерию и движения товара; "
            "возобновляемый импорт поставок, диагностика Baserow/R2 и журнал действий."
        ),
    ),
    ProductFeature(
        title="Заказ Sonu",
        ...
        description=(
            ...
            "пополнению и постоянным облачным хранением решений по спорным моделям."
        ),
    ),
    ProductFeature(
        ...
        description=(
            ...
            "история, готовый Excel и подтверждённое локальное/облачное сохранение."
        ),
    ),
    ProductFeature(
        title="Документация",
