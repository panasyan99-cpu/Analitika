...
PRODUCT_FEATURES: tuple[ProductFeature, ...] = (
    ...
    ProductFeature(
        ...
        mode="Заказ Sonu",
        description=(
            "Полный управленческий отчет Sonu: продажи и общий остаток сети считаются один "
            "раз на SKU, AI-приоритет показывает путь от «Очень нужно заказать» до «Не "
            "критично». Большая сводка раскрывает группу камней, вид камня и номенклатурную "
            "группу; таблицы переключаются на карточки с настраиваемой сортировкой. Браслеты "
            "разделены на «С затяжкой» и «Без затяжки (в круг)» с отдельными графиками и "
            "сводками."
        ),
    ),
    ProductFeature(
