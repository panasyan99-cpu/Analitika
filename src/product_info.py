...
PRODUCT_FEATURES: tuple[ProductFeature, ...] = (
    ...
    ProductFeature(
        ...
        description=(
            ...
            "участники групп, браслеты и детализация моделей. Доступна единая Excel-выгрузка "
    ...
    ProductFeature(
        ...
        description=(
            "Адаптивная работа на ПК, iPad и смартфонах, единые черно-золотые кнопки "
            "и навигация, сортируемые таблицы, заблокированные от случайного изменения диаграммы, "
