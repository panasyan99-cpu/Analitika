...
PRODUCT_FEATURES: tuple[ProductFeature, ...] = (
    ...
    ProductFeature(
        ...
        mode="Заказ Sonu",
        description=(
            "Полный последовательный отчет с боковой навигацией: продажи по магазинам, "
            "средние продажи и взвешенная средняя цена, разбор браслетов и камней, "
            "прогноз продаж, матрица заказа и рекомендации. Доступна единая Excel-выгрузка "
            "со всеми блоками и прогнозами 30/60/90 дней. Возвраты не учитываются; "
            "все суммы выводятся в USD."
        ),
    ),
    ProductFeature(
