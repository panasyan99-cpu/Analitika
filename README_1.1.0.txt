...
4. Скачайте artifact Analitika_Setup_1.1.5.
5. Передайте файл Analitika_Setup_1.1.5.exe руководителям.

Для автообновлений:
- замените OWNER/REPOSITORY в update_config.json на имя репозитория;
- создавайте релизы с тегами v1.1.5, v1.2.0 и прикладывайте установщик.
